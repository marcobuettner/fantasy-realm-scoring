...
class DiscardArea(private val displayId: Int, private val game: Game, override var totalScore: Int) : WithGame{
    ...
    companion object {
        val instance: DiscardArea = DiscardArea(R.string.discard_area, Game(true), 0)
    }
}
